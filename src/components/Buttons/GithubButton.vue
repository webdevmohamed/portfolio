<template>
  <a href="https://github.com/your-github" target="_blank"
     class="group relative flex items-center gap-2 p-3 bg-background rounded-xl
               shadow-lg hover:shadow-primary/50 dark:hover:shadow-primary/20 transition-all duration-300">
    <svg class="w-6 h-6 text-foreground group-hover:text-primary-400 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24">
