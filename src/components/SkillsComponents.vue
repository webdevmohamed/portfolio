      ...
      <div class="flex flex-wrap justify-center gap-5">
        <TransitionGroup name="skill-fade">
          <a
            ...
            class="relative overflow-hidden group flex items-center justify-center p-3 rounded-full border-2 bg-gradient-to-b from-accent-blue/10 to-primary/10 border-transparent hover:border-foreground hover:bg-none transition-all duration-300 hover:scale-105 hover:shadow-lg w-20 md:w-24 aspect-square"
          >
