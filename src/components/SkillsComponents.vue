      ...
      <div class="flex flex-wrap justify-center gap-5">
        <TransitionGroup name="skill-fade">
          <a
            ...
            class="relative overflow-hidden group flex items-center justify-center p-3 rounded-full ring-2 ring-transparent bg-gradient-to-b from-accent-blue/20 to-primary/20 border-transparent hover:ring-foreground hover:bg-none transition-all duration-300 hover:scale-105 hover:shadow-lg w-20 md:w-24 aspect-square"
          >
